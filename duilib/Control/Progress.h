...
public:
	 ...
	 * @return 无
	 */
	int64_t GetMarqueeWidth();

	/**
	 * @brief 设置Marquee宽度
	 * @return 无
	 */
	void SetMarqueeWidth(int64_t nMarqueeWidth);

	/**
	 * @brief 获取Marquee步长
	 * @return 无
	 */
	int64_t GetMarqueeStep();

	/**
	 * @brief 设置Marquee步长
	 * @return 无
	 */
	void SetMarqueeStep(int64_t nMarqueeStep);

	/**
	 * @brief 获取Marquee持续时间
	 * @return 无
	 */
	int64_t GetMarqueeElapsed();

	/**
	 * @brief 设置Marquee持续时间
	 * @return 无
	 */
	void SetMarqueeElapsed(int64_t nMarqueeElapsed);
...
protected:
	...
	bool m_bMarquee;
	int64_t m_nMarqueeWidth;
	int64_t m_nMarqueeStep;
	int64_t m_nMarqueeElapsed;
	int64_t m_nMarqueePos;
