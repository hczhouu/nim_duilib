...
int64_t Progress::GetMinValue() const
{
	return m_nMin;
}

void Progress::SetMinValue(int64_t nMin)
{
	m_nMin = nMin;
	Invalidate();
}

int64_t Progress::GetMaxValue() const
{
	return m_nMax;
}

void Progress::SetMaxValue(int64_t nMax)
{
	m_nMax = nMax;
	Invalidate();
}
...
int64_t Progress::GetMarqueeWidth()
{
	return m_nMarqueeWidth;
}

void Progress::SetMarqueeWidth(int64_t nMarqueeWidth)
{
...
int64_t Progress::GetMarqueeStep()
{
	return m_nMarqueeStep;
}

void Progress::SetMarqueeStep(int64_t nMarqueeStep)
{
...
int64_t Progress::GetMarqueeElapsed()
{
	return m_nMarqueeElapsed;
}

void Progress::SetMarqueeElapsed(int64_t nMarqueeElapsed)
{
