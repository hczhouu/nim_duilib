...
public:
	...
	friend void ShowMessageBox(HWND hwnd, MsgboxCallback cb, const std::wstring& content,
		const std::wstring& strCaption, const std::wstring& strYes, 
		const std::wstring& strNo, const MsgBoxType& mbType);
public:
	MsgBox();
...
private:
	...
	void SetMsgBoxType(const std::wstring& strYes, const std::wstring& strNo, const MsgBoxType& mbType);
public:
